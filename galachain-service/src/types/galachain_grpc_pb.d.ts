...
interface IGalaChainServiceService_IGetPrice extends grpc.MethodDefinition<
  galachain_pb.GetPriceRequest,
  galachain_pb.PriceResponse
> {
...
interface IGalaChainServiceService_IGetBalance extends grpc.MethodDefinition<
  galachain_pb.BalanceRequest,
  galachain_pb.BalanceResponse
> {
...
interface IGalaChainServiceService_IExecuteSwap extends grpc.MethodDefinition<
  galachain_pb.SwapRequest,
  galachain_pb.SwapResponse
> {
...
interface IGalaChainServiceService_IWatchPrices extends grpc.MethodDefinition<
  galachain_pb.WatchPricesRequest,
  galachain_pb.PriceUpdate
> {
...
interface IGalaChainServiceService_ICreateWalletSession extends grpc.MethodDefinition<
  galachain_pb.WalletSessionRequest,
  galachain_pb.WalletSessionResponse
> {
...
interface IGalaChainServiceService_IHealthCheck extends grpc.MethodDefinition<
  galachain_pb.HealthCheckRequest,
  galachain_pb.HealthCheckResponse
> {
...
export interface IGalaChainServiceServer extends grpc.UntypedServiceImplementation {
  ...
  watchPrices: grpc.handleServerStreamingCall<
    galachain_pb.WatchPricesRequest,
    galachain_pb.PriceUpdate
  >;
  createWalletSession: grpc.handleUnaryCall<
    galachain_pb.WalletSessionRequest,
    galachain_pb.WalletSessionResponse
  >;
...
export interface IGalaChainServiceClient {
  getPrice(
    request: galachain_pb.GetPriceRequest,
    callback: (error: grpc.ServiceError | null, response: galachain_pb.PriceResponse) => void
  ...
  getBalance(
    request: galachain_pb.BalanceRequest,
    callback: (error: grpc.ServiceError | null, response: galachain_pb.BalanceResponse) => void
  ): grpc.ClientUnaryCall;
  getBalance(
    request: galachain_pb.BalanceRequest,
    metadata: grpc.Metadata,
  ...
  executeSwap(
    request: galachain_pb.SwapRequest,
    callback: (error: grpc.ServiceError | null, response: galachain_pb.SwapResponse) => void
  ): grpc.ClientUnaryCall;
  executeSwap(
    request: galachain_pb.SwapRequest,
    metadata: grpc.Metadata,
  ...
  watchPrices(
    request: galachain_pb.WatchPricesRequest,
    options?: Partial<grpc.CallOptions>
  ): grpc.ClientReadableStream<galachain_pb.PriceUpdate>;
  watchPrices(
    request: galachain_pb.WatchPricesRequest,
    metadata?: grpc.Metadata,
    options?: Partial<grpc.CallOptions>
  ...
  createWalletSession(
    request: galachain_pb.WalletSessionRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: galachain_pb.WalletSessionResponse
    ) => void
  ): grpc.ClientUnaryCall;
  createWalletSession(
    request: galachain_pb.WalletSessionRequest,
  ...
  healthCheck(
    request: galachain_pb.HealthCheckRequest,
    callback: (error: grpc.ServiceError | null, response: galachain_pb.HealthCheckResponse) => void
  ): grpc.ClientUnaryCall;
  healthCheck(
    request: galachain_pb.HealthCheckRequest,
    metadata: grpc.Metadata,
