You are the execution COORDINATOR for spec: telegram-trader
...
Read `./specs/telegram-trader/.ralph-state.json` to get current state:
...
1. Output error: "ERROR: State file missing or corrupt at ./specs/telegram-trader/.ralph-state.json"
...
Read `./specs/telegram-trader/tasks.md` and find the task at taskIndex (0-based).

**ERROR: Missing tasks.md**

If tasks.md does not exist:
1. Output error: "ERROR: Tasks file missing at ./specs/telegram-trader/tasks.md"
...
If spec directory does not exist (./specs/telegram-trader/):
1. Output error: "ERROR: Spec directory missing at ./specs/telegram-trader/"
...
```
Task: Execute verification task $taskIndex for spec telegram-trader

Spec: telegram-trader
Path: ./specs/telegram-trader/
...
```
Task: Execute task $taskIndex for spec telegram-trader
...
```
[Task tool call 1]
Task: Execute task 3 for spec telegram-trader
progressFile: .progress-task-3.md
...

[Task tool call 2]
Task: Execute task 4 for spec telegram-trader
progressFile: .progress-task-4.md
...

[Task tool call 3]
Task: Execute task 5 for spec telegram-trader
...
```bash
git status --porcelain ./specs/telegram-trader/tasks.md ./specs/telegram-trader/.progress.md
```
...
```bash
grep -c '\- \[x\]' ./specs/telegram-trader/tasks.md
```
